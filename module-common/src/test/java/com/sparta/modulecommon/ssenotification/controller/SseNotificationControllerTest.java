package com.sparta.modulecommon.ssenotification.controller;//package com.sparta.fitnus.ssenotification.controller;
//
...
//            given(sseNotificationServiceImpl.getUnreadNotifications(authUser.getId())).willReturn(notifications);
//
//            // When
//            sseNotificationController.getUnreadNotifications(authUser, "unread");
//
//            // Then
//            verify(sseNotificationServiceImpl, times(1)).getUnreadNotifications(authUser.getId());
//        }
//
//        @Test
//        void all_성공() {
...
//            AuthUser authUser = new AuthUser(1L, UserRole.USER, "test@test.com", "test");
//            List<EventPayload> notifications = new ArrayList<>();
//            given(sseNotificationServiceImpl.getAllNotifications(authUser.getId())).willReturn(notifications);
//
//            // When
//            sseNotificationController.getUnreadNotifications(authUser, "all");
//
//            // Then
//            verify(sseNotificationServiceImpl, times(1)).getAllNotifications(authUser.getId());
//        }
//    }
//
//    @Nested
